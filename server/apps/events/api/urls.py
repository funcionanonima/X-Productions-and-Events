...
from apps.events.api.views.general_views import EventCreateAPIView, EventListAPIView, EventRetrieveAPIView, EventDestroyAPIView, EventUpdateAPIView, EventListFormatedAPIView
